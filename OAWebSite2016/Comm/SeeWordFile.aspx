<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeeWordFile.aspx.cs" StylesheetTheme=""
    Inherits="OAWebSite.WebUI.Common.SeeWordFile" %>
...
<body onload="javascript:myLoad();" onunload="javascript:myUnload();">
    ...
    <div id="div1" style="text-align: center; height: 100%; margin-top: 2px">
        <table width="100%" align="center" bgcolor="#c5c5c5" cellpadding="1" cellspacing="1"
            ...
            <tr bgcolor="#f0f8ff" >
                <td align="left">
                   <input class="btn" type="button" id="but2" value="保存到服务器>>" title="保存文件到服务器"
                        onclick="javaScript:return SaveDoc();" runat="server" name="but2" visible="false"  />
                </td>
            </tr>
