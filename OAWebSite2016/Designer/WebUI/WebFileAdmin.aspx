...
Inherits="WebFrame.Designer.WebFileAdmin"
StylesheetTheme="" %>
...
<head id="Head1" runat="server">
    <title>在线文件管理</title>
    <link href="/css/WebFileStyleSheet.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div id="menu">
        <ul>
            <li><a href="WebFileAdmin.aspx">
                <img title="刷新" alt="刷新" src="/images/Frame/ico/refresh.gif" />
                刷新</a></li>
            <li><a href="javascript:void(0);" id="create">
                <img title="新建" alt="新建" src="/images/Frame/ico/folder_new.gif" />
                新建文件夹</a></li>
            <li><a href="javascript:void(0);" id="createfile">
                <img title="新建" alt="新建" src="/images/Frame/ico/file_new.gif" />
                新建文件</a></li>
            <li><a href="javascript:void(0);" id="cut">
                <img title="剪切" alt="剪切" src="/images/Frame/ico/cut.gif" />
                剪切</a></li>
            <li><a href="javascript:void(0);" id="copy">
                <img title="复制" alt="复制" src="/images/Frame/ico/copy.gif" />
                复制</a></li>
            <li><a href="javascript:void(0);" id="paste">
                <img title="粘贴" alt="粘贴" src="/images/Frame/ico/paste.gif" />
                粘贴</a></li>
            <li><a href="javascript:void(0);" id="edit">
                <img title="编辑" alt="编辑" src="/images/Frame/ico/edit.gif" />
                编辑</a></li>
            <li><a href="javascript:void(0);" id="rename">
                <img title="重命名" alt="重命名" src="/images/Frame/ico/rename.gif" />
                重命名</a></li>
            <li><a href="javascript:void(0);" id="delete">
                <img title="删除" alt="删除" src="/images/Frame/ico/delete.gif" />
                删除</a></li>
            <li><a href="javascript:void(0);" id="upload">
                <img title="上传" alt="上传" src="/images/Frame/ico/up.gif" />
                上传</a></li>
        </ul>
    </div>
    ...
    <div id="divEditFile" class="jqmWindow" style="display: none;">
        <h3>
            编辑文件</h3>
        <p>
            路径：<asp:Label ID="FilePath" Text="FilePath" Font-Bold="true" runat="server" Font-Names="Verdana"
                Font-Size="12px"></asp:Label><br />
            <br />
            <p>
    ...
    <div style="padding: 5px;">
        <strong>路径: </strong>
        <asp:Label ID="lblCurrentPath"  runat="server" Font-Names="Verdana"
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="CreationDate" HeaderText="创建日期">
                    <ItemStyle Width="15%" Wrap="False" HorizontalAlign="Center" />
                </asp:BoundField>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <asp:LinkButton ID="DownLinkBtn" runat="server" CommandArgument='<%# Eval("FullName") %>'
                            CommandName="DownLoad" Text='<img  alt="" src="/images/Frame/ico/down2.jpg" width="16" height="16" border="0" /> 下载'
                            ForeColor="Black"></asp:LinkButton>
                        <span id="span1" runat="server">&nbsp;&nbsp;
                            <img src="/images/Frame/edt.gif" width="16" height="16" border="0" alt="" /><a target="_blank"
                                href='/Comm/ScanFile.aspx?filepath=<%# Server.UrlEncode(Eval("FullName").ToString()) %>'
                                class="blue"> 在线编辑</a></span>
                    </ItemTemplate>
