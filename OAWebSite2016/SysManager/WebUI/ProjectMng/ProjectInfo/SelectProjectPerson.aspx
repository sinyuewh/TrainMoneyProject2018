<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectProjectPerson.aspx.cs" 
MasterPageFile="~/SysManager/include/H-uiThird.Master"
 Title ="选择项目的成员"
Inherits="OAWebSite2016.SysManager.WebUI.ProjectMng.ProjectInfo.SelectProjectPerson" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function InitTreeData() {
            $('#tree').tree({
            url: '/SysManager/WebUI/PubLib/GetEasyUITreeData.aspx?dataKind=0&RoleID=<%=Request["RoleID"]%>&oldUsers=<%=Request["oldUsers"]%>',
                checkbox: true
            });
        }
        ...
        function getChecked() {
            ...
            if (s.length == 0) 
            {
                ...
                $('#<%=Request["parentid"] %>', window.opener.document).val(s);
                window.close();
                return false;
            }
        }
        ...
        <jasp:SecurityPanel ID="sec0" runat="server" RoleID="xtgl">
           <%-- <input class="btn btn-primary radius" runat="server" id="btnSubmit" type="submit"
            ...
            <jasp:JButton ID="but1" runat ="server" Text =" 提 交 "
             ...
             &nbsp;&nbsp;
                <button onclick="javascript:window.close();" class="btn btn-default radius" type="button"> 取 消 </button>
        </jasp:SecurityPanel>
    </div>
