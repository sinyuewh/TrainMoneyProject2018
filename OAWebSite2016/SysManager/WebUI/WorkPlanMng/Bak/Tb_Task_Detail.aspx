<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tb_Task_Detail.aspx.cs"
    MasterPageFile="~/SysManager/include/H-uiThird.Master" 
    Inherits="OAWebSite2016.SysManager.WebUI.WorkPlanMng.Tb_Task_Detail1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function CalWorkLoad() {
            var t2 = $('#<%=this.endDate.ClientID%>').val();
            var t1 = $('#<%=this.begDate.ClientID%>').val();
            
            if (t2 != "" && t1 != "") {
                var a1 = DateDiff(t2, t1);
                $('#<%=this.Workload.ClientID%>').val(a1 * 8 + "")
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <jasp:JDataBean ID="bean1" runat="server" DataSourceID="data1" 
        ControlList="GuidID,begDate,endDate,Workload,content,Status,AddUser"
    ...
    <div class="row cl">
        ...
        <div class="formControls col-10">
            <jasp:JTextBox class="input-text" ID="begDate" runat="server" Caption="计划开始" DataType="DateTime"
                onclick="$.calendar();" AllowNullValue="false" Width="29%" />&nbsp;至&nbsp;
            <jasp:JTextBox class="input-text" ID="endDate" runat="server" Caption="计划结束时间" DataType="DateTime"
                onclick="$.calendar();" AllowNullValue="false" Width="29%" />
             工作量预估：<jasp:JTextBox class="input-text" AllowNullValue="false" ID="Workload" runat="server"
    ...
    <div class="row cl">
        ...
        <div class="formControls col-10">
            <jasp:JTextBox class="input-text" AllowNullValue="false" ID="content" runat="server"
                Caption="计划工作内容" mydatatype="*10-600" TextMode="MultiLine" Height="260px" />
        </div>
    </div>
