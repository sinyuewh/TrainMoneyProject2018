...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <span class="l">
                <jasp:SecurityPanel ID="sec1" runat="server">
                    <a href="javascript:;" onclick="javascript:return NewData();" class="btn btn-primary radius">
                        <i class="Hui-iconfont">&#xe600;</i> 添加周计划</a>
                </jasp:SecurityPanel>
        ...
        <jasp:JDataSource ID="data1" runat="server" JType="Table" SqlID="Tb_PlanView"
            ...
            <ParaItems>
                ...
                <jasp:ParameterItem ParaType="Control" ParaName="Status" DataType="NumericType" />
                 <jasp:ParameterItem ParaType="String" ParaName="xx" DataName="PlanKind=2"   SearchOperator="UserDefine"  />
                        ...
                        <ItemTemplate>
                            <tr class="text-c">
                               ...
                               <td class="operate">
                                ...
                                <td class="operate">
                                    <a  target="_blank" title="查看计划的详细情况"  href='Tb_Plan_Detail3.aspx?PlanID=<%#Eval("PlanID")%>'>【查看详细】</a>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
    ...
    <script type="text/javascript">
        ...
        function NewData() {
            var title = "添加项目周计划";
            var url = "Tb_Project_Detail_ADD3.aspx";
