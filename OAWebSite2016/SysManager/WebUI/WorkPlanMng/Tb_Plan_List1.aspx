...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--导航区设置-->
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 计划管理 <span class="c-gray en">&gt;</span> 总体计划 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="pd-20">
        <!--查询区设置-->
        <div class="text-c">
            ...
            <span class="l">
                <jasp:SecurityPanel ID="sec1" runat="server">
                    <a href="javascript:;" onclick="javascript:return NewData();" class="btn btn-primary radius">
                        <i class="Hui-iconfont">&#xe600;</i> 添加整体计划</a>
                </jasp:SecurityPanel>
        ...
        <jasp:JDataSource ID="data1" runat="server" JType="Table" SqlID="Tb_PlanView"
            ...
            <ParaItems>
                ...
                <jasp:ParameterItem ParaType="Control" ParaName="Status" DataType="NumericType" />
                 <jasp:ParameterItem ParaType="String" ParaName="xx" DataName="PlanKind=0"   SearchOperator="UserDefine"  />
                        ...
                        <ItemTemplate>
                            <tr class="text-c">
                               ...
                               <td class="operate">
                                ...
                                <td class="operate">
                                    <a  target="_blank" title="查看计划的详细情况"  href='Tb_Plan_Detail1.aspx?PlanID=<%#Eval("PlanID")%>'>【查看详细】</a>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
