<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SysManager/include/H-uiThird.Master"
    CodeBehind="Tb_Project_Detail_ADD3.aspx.cs" Inherits="OAWebSite2016.SysManager.WebUI.WorkPlanMng.Tb_Project_Detail_ADD3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row cl" id="sel1" runat="server">
        ...
        <div class="formControls col-8">
            <span class="select-box">
                <jasp:AppDropDownList ID="selecProject" runat="server" CssClass="select" BlankValue="--请选择--"
                    AllowNullValue="false" Caption="选择项目" AutoPostBack ="true" >
    ...
    <div class="row cl">
        <label class="form-label col-3">
            计划周次：</label>
        <div class="formControls col-8">
            <jasp:JTextBox class="input-text" AllowNullValue="false" ID="PlanWeek" runat="server"
                Caption="计划周次" />
        </div>
    </div>
    <div class="row cl">
        ...
        <div class="formControls col-8">
            <jasp:JTextBox class="input-text" ID="begDate" runat="server" AllowNullValue="false"
                Caption="开始日期" onclick="$.calendar();" Width="230px" />
            <b>至</b>
            <jasp:JTextBox class="input-text" ID="endDate" runat="server" AllowNullValue="false"
                Caption="预计结束日期" onclick="$.calendar();" Width="230px" />
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-3">
            备注：</label>
        <div class="formControls col-8">
            <jasp:JTextBox class="input-text" TextMode="MultiLine" Height="200px" AllowNullValue="false"
                ID="Remark" runat="server" Caption="计划备注" />
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-3">
