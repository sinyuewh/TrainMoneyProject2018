<%@ Page Title="项目总体计划" Language="C#" MasterPageFile="~/SysManager/include/H-uiSecond.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--导航区设置-->
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 总体计划详细  <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="pd-20">
        <!--查询区设置-->
        <div class="text-c">
            关键节点：<span class="select-box" style="width: 150px">
                <jasp:JDropDownList ID="KeyPlan" class="select" runat="server">
                    <asp:ListItem Text="--不限--" Value=""></asp:ListItem>
                     <asp:ListItem Text="关键节点" Value="true"></asp:ListItem>
                    <asp:ListItem Text="非关键节点" Value="false"></asp:ListItem>
                </jasp:JDropDownList>
            </span>&nbsp;&nbsp; 计划编号：<jasp:JTextBox ID="PlanNum" runat="server" class="input-text"
        ...
        <jasp:JDataSource ID="data1" runat="server" JType="Table" SqlID="Tb_PlanDetailView" PageSize="-1"
            ...
            <ParaItems>
                ...
                <jasp:ParameterItem ParaType="Control" ParaName="KeyPlan"  DataType="NumericType"  />
            </ParaItems>
        </jasp:JDataSource>
        <!--数据表格-->
