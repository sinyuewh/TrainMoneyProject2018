<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SysManager/include/H-uiThird.Master"
    CodeBehind="Tb_KaoHeZhiBiao_Detail.aspx.cs" Inherits="OAWebSite2016.SysManager.WebUI.CheckMng.Tb_KaoHeZhiBiao_Detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <jasp:JDataBean ID="bean1" runat="server" DataSourceID="data1" ControlList="num,KHID,KhRemark,KhScore,remark,createtime,Status"
    ...
    <div class="row cl">
        ...
        <div class="formControls col-8">
            <jasp:JTextBox class="input-text" AllowNullValue="false" ID="KHID" runat="server"
                Caption="考核编码" IsUnique="true" UniqueTable="Tb_KaoHeZhiBiao" mydatatype="*1-20" />
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-3">
            考核规范：</label>
        <div class="formControls col-8">
            <jasp:JTextBox ID="KhRemark" runat="server" TextMode="MultiLine" Height="120px" Caption="考核规范"
    ...
    <!--控制修改的权限-->
    <jasp:SecurityPanel ID="sec0" runat="server" AuthorityID="Tb_KaoHeZhiBiao_EDIT">
        <div class="row cl">
    ...
    <jasp:SecurityPanel ID="SecurityPanel1" runat="server" AuthorityKind="DirectNoAccessPage"
        AuthorityID="Tb_KaoHeZhiBiao_READ">
    </jasp:SecurityPanel>
