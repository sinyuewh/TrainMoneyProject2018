<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TodayWorkList2.aspx.cs" 
MasterPageFile="~/SysManager/include/H-uiSecond.Master"
Inherits="OAWebSite2016.SysManager.WebUI.WorkLogMng.TodayWorkList2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" DataSourceID="data1" EnableViewState="false" >
                        <ItemTemplate>
                            <tr class="text-c">
                                ...
                                <td>
                                    <%#KORWeb.BUL.Tb_WorkLogBU.GetWorkLogContent(Eval("PlanNum").ToString())%>
                                </td>
                               
                                <td class="operate">
                                    <a href="#" onclick='javascript:CheckWork("<%#Eval("TaskId")%>");return false;'>【确定工作】</a>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
    ...
    <script type="text/javascript">
        ...
        //1---确定工作
        function CheckWork(dataid) {
            layer.confirm("提示：确定要执行操作吗？", function() {
                 layer.prompt({ title: '请输入备注', formType: 2,value: '无'}, function(text) {
