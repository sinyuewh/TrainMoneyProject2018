<%@ Page Title="" Language="C#" MasterPageFile="~/SysManager/include/H-uiSecond.Master"
    AutoEventWireup="true" CodeBehind="WorkLogList3.aspx.cs" Inherits="OAWebSite2016.SysManager.WebUI.WorkLogMng.WorkLogList3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pd-20">
        ...
        <!--数据源定义-->
        <jasp:JDataSource ID="data1" runat="server" JType="Table" SqlID="Tb_TodayWorkView"
            PageSize="-1" FieldsList="*" OrderBy="begDate desc" IsAddWhere="true">
            <ParaItems>
    ...
    <jasp:SecurityPanel ID="sec0" runat="server" AuthorityKind="DirectNoAccessPage" AuthorityID="Tb_WorkLog_READ">
    </jasp:SecurityPanel>
</asp:Content>
