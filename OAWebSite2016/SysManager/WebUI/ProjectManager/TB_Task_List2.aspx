<%@ Page Title="" Language="C#" MasterPageFile="~/SysManager/include/H-uiSecond.Master"
    AutoEventWireup="true" CodeBehind="TB_Task_List2.aspx.cs" Inherits="OAWebSite2016.SysManager.WebUI.ProjectManager.TB_Task_List2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--导航区设置-->
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 项目经理 <span class="c-gray en">&gt;</span> 测试中的工单 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="pd-20">
        <!--查询区设置-->
        <div class="text-c">
        ...
        <jasp:JDataSource ID="data1" runat="server" JType="Table" SqlID="Tb_Task inner join Tb_Project on Tb_Task.ProjectGuidID=Tb_Project.Guidid"
            PageSize="-1" FieldsList="TaskId,Tb_Task.Guidid,Tb_Task.AddTime,prjName,TaskTitle,Tb_Task.begDate,Tb_Task.endDate,Tb_Task.WorkLoad,Tb_Task.Relafile,RelaTrueName,ExecuteMan,TestMan,Tb_Task.finishDate,TestUrl"
            ...
            <ParaItems>
                ...
                <jasp:ParameterItem ParaType="Control" ParaName="Time1" DataName="Tb_Task.AddTime<=cdate('{0} 23:59:59')"
                    SearchOperator="UserDefine" />
                <jasp:ParameterItem ParaType="String" ParaName="xx" DataName="(Tb_Task.Status ='2' and ExecuteMan is not null)"
                    SearchOperator="UserDefine" />
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" DataSourceID="data1" EnableViewState="false">
                        <ItemTemplate>
                            <tr class="text-c">
                                ...
                                <td class="operate">
                                    <a title="点击进入测试页" href='<%#Eval("TestUrl")%>' target="_blank"><%#KORWeb.BUL.JUserBU.GetUserNamByIDS(Eval("TestMan").ToString())%></a>
                                </td>
                                ...
                                <td class="operate">
                                    ...
                                    &nbsp;<a onclick="javascript:return SubmitTestResult('<%#Eval("Guidid") %>');" href='#'><img
                                        alt="" src="/images/gou2.gif" width="16" height="16" border="0" />测试结果</a>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
    ...
    <script type="text/javascript">
        ...
        //登记测试结果
        function SubmitTestResult(dataid) {
            var title = "派工单测试结果";
            var url = "TB_Task_SubmitTestResult.aspx?GuidID=" + dataid;
