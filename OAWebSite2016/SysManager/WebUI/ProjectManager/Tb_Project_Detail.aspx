<%@ Page Title="" Language="C#" MasterPageFile="~/SysManager/include/H-uiThird.Master"
    AutoEventWireup="true" CodeBehind="Tb_Project_Detail.aspx.cs" Inherits="OAWebSite2016.SysManager.WebUI.WorkMng.Tb_Project_Detail" %>
        ...
        <div class="tabCon">
                    ...
                    <div class="cl pd-5 bg-1 bk-gray mt-20">
                        <span class="l">
                            <jasp:SecurityPanel ID="sec1" runat="server">
                                <a href="javascript:;" onclick="javascript:return NewAttachment();" class="btn btn-primary radius">
                                    <i class="Hui-iconfont">&#xe600;</i> 添加新附件</a>
                            </jasp:SecurityPanel>
                                    ...
                                    <ItemTemplate>
                                        <tr class="text-c">
                                            ...
                                            <td class="operate">
                                                ...
                                                <jasp:SecurityPanel ID="sec0" runat="server" AuthorityID="Tb_Project_ATTACH" IsAlwaysReload="true">
                                                    &nbsp;<a onclick="javascript:return DelAttachmentData('<%#Eval("guidID") %>');" href='#'><img
            ...
            <script language="javascript" type="text/javascript">
                ...
                function NewAttachment() {
                    var title = "添加新项目附件";
                    var url = "Tb_Project_Attachment_ADD.aspx?parentGuid=" + $('#<%=this.guidID.ClientID%>').val();
                    layer_show(title, url, 650, 450);
                }

                //删除项目附件
                function DelAttachmentData(dataid) {
                    layer.confirm("提示：确定要删除选中的附件吗？", function() {
                        $.ajax({
                            type: 'POST',
                            url: "Handler/DoAction.aspx",
                            data: {
                                KeyID: dataid,
                                Action: 'DEL_Tb_Project_ATTACHMENT'
                            },
                            success: function(data) {
                                if ("ok" == data) {
                                    var index1 = layer.alert("删除数据操作成功！", function() {
                                        $('#ctl00_ContentPlaceHolder1_butRefresh1').click();  //重新加载页面
                                        layer.close(index1);
                                    });
