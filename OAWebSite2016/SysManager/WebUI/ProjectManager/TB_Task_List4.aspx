<%@ Page Title="" Language="C#" MasterPageFile="~/SysManager/include/H-uiSecond.Master"
    AutoEventWireup="true" CodeBehind="TB_Task_List4.aspx.cs"
     Inherits="OAWebSite2016.SysManager.WebUI.ProjectManager.TB_Task_List4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--导航区设置-->
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 项目经理 <span class="c-gray en">&gt;</span> 已完成的工单 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="pd-20">
        <!--查询区设置-->
        <div class="text-c">
        ...
        <jasp:JDataSource ID="data1" runat="server" JType="Table" SqlID="Tb_Task inner join Tb_Project on Tb_Task.ProjectGuidID=Tb_Project.Guidid"
            PageSize="-1" FieldsList="TaskId,Tb_Task.Guidid,Tb_Task.AddTime,prjName,TaskTitle,Tb_Task.begDate,Tb_Task.endDate,Tb_Task.WorkLoad,Tb_Task.Relafile,RelaTrueName,ExecuteMan,TestMan,TestUrl,Tb_Task.finishDate,LastWorkLoad"
                        ...
                        <ItemTemplate>
                            <tr class="text-c">
                                ...
                                <td class="operate">
                                    ...
                                    &nbsp;<a onclick="javascript:return SubmitDebug('<%#Eval("Guidid") %>');" href='#'><img
                                        alt="" src="/images/zhuxiao.jpg" width="16" height="16" border="0" />登记BUG</a>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
    ...
    <script type="text/javascript">
        ...
        //2---登记Debug
        function SubmitDebug(dataid) {
            var title = "登记派工单BUG";
            var url = "TB_Task_SubmitBUG.aspx?GuidID=" + dataid;
            layer_show(title, url, 800, 450);
        }
    </script>
