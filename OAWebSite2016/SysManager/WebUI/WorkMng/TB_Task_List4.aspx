<%@ Page Title="" Language="C#" MasterPageFile="~/SysManager/include/H-uiSecond.Master"
    AutoEventWireup="true" CodeBehind="TB_Task_List4.aspx.cs" Inherits="OAWebSite2016.SysManager.WebUI.WorkMng.TB_Task_List4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--导航区设置-->
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 工作管理 <span class="c-gray en">&gt;</span> 已完成的工单 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="pd-20">
        <!--查询区设置-->
        <div class="text-c">
        ...
        <jasp:JDataSource ID="data1" runat="server" JType="Table" SqlID="Tb_Task inner join Tb_Project on Tb_Task.ProjectGuidID=Tb_Project.Guidid"
            ...
            <ParaItems>
                ...
                <jasp:ParameterItem ParaType="String" ParaName="xx" DataName="(Tb_Task.Status ='4' and ExecuteMan is not null)"
                 ...
                 <jasp:ParameterItem ParaType="Control" ParaName="ExecuteMan"  />
                <%-- <jasp:ParameterItem ParaType="FrameLibPara" FrameLibParaName="UserID" ParaName="xx"
                    DataName="Tb_Task.ExecuteMan" />--%>
            </ParaItems>
        </jasp:JDataSource>
        <!--数据表格-->
    ...
    <script type="text/javascript">
        $(function() {
            $('.table-sort').dataTable({
                ...
                //                { "bVisible": false, "aTargets": [0] }, //控制列的隐藏显示
		          {"orderable": false, "aTargets": [15]}// 制定列不参与排序
		        ]
            });
        ...
        function SubmitDebug(dataid) {
            var title = "登记派工单BUG";
            var url = "../ProjectManager/TB_Task_SubmitBUG.aspx?GuidID=" + dataid;
