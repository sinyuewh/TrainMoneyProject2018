<%@ Page Title="" Language="C#" MasterPageFile="~/SysManager/include/H-uiSecond.Master"
    AutoEventWireup="true" CodeBehind="TB_Task_List0.aspx.cs" 
    Inherits="OAWebSite2016.SysManager.WebUI.WorkMng.TB_Task_List0" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <tr class="text-c">
                                ...
                                <td class="operate">
                                    ...
                                    <jasp:SecurityPanel ID="sec0" runat="server" IsAlwaysReload="true">
                                        &nbsp;<a onclick="javascript:return ReceiveTask('<%#Eval("Guidid") %>');" href='#'><img
                                            alt="" src="/images/gou2.gif" width="16" height="16" border="0" />接单</a>
                                    </jasp:SecurityPanel>
    ...
    <script type="text/javascript">
        ...
        //3*--用户自主接单
        function ReceiveTask(dataid) {
            layer.confirm("提示：确定要接工单吗？", function() {
                $.ajax({
                    type: 'POST',
                    url: "Handler/DoAction.aspx",
                    data: {
                        KeyID: dataid,
                        Action: 'RECEIVE_Tb_Task'
                    },
                    success: function(data) {
                        if ("ok" == data) {
                            layer.alert("接工单操作成功！", function() {
