<%@ Page Title="" Language="C#" MasterPageFile="~/SysManager/include/H-uiSecond.Master"
    AutoEventWireup="true" CodeBehind="TB_Task_List3.aspx.cs" 
    Inherits="OAWebSite2016.SysManager.WebUI.WorkMng.TB_Task_List3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--导航区设置-->
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 工作管理 <span class="c-gray en">&gt;</span> 审核中的工单 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="pd-20">
        <!--查询区设置-->
        <div class="text-c">
        ...
        <jasp:JDataSource ID="data1" runat="server" JType="Table" SqlID="Tb_Task inner join Tb_Project on Tb_Task.ProjectGuidID=Tb_Project.Guidid"
            PageSize="-1" FieldsList="TaskId,Tb_Task.Guidid,Tb_Task.AddTime,prjName,TaskTitle,Tb_Task.begDate,Tb_Task.endDate,Tb_Task.WorkLoad,Tb_Task.Relafile,RelaTrueName,ExecuteMan,TestMan,Tb_Task.finishDate,TestUrl,Tb_Task.AddUser,Manager"
            ...
            <ParaItems>
                ...
                <jasp:ParameterItem ParaType="Control" ParaName="Time1" DataName="Tb_Task.AddTime<=cdate('{0} 23:59:59')"
                    SearchOperator="UserDefine" />
                <jasp:ParameterItem ParaType="String" ParaName="xx" DataName="(Tb_Task.Status ='3' and ExecuteMan is not null)"
                    SearchOperator="UserDefine" />
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" DataSourceID="data1" EnableViewState="false">
                        <ItemTemplate>
                            <tr class="text-c">
                                ...
                                <td>
                                    <span title='<%#Eval("PrjName") %>'>
                                        <%# WebFrame.Util.JString.GetMaxLenth(Eval("PrjName").ToString(),8,"...") %>
                                    </span>
                                </td>
                                <td>
                                    <span title='<%#Eval("TaskTitle") %>'>
                                        <%# WebFrame.Util.JString.GetMaxLenth(Eval("TaskTitle").ToString(), 8, "...")%>
                                    </span>
                                </td>
                                <td>
                                ...
                                <td class="operate">
                                    ...
                                    <span id="span1" style='display:<%#Eval("Manager").ToString()==WebFrame.FrameLib.UserID ? "":"none" %>'>&nbsp;<a onclick="javascript:return SubmitCheckTest('<%#Eval("Guidid") %>');"
                                        href='#'><img alt="" src="/images/gou2.gif" width="16" height="16" border="0" />审核结果</a>
    ...
    <script type="text/javascript">
        ...
        function SubmitCheckTest(dataid) {
            var title = "派工单审核结果";
            var url = "../ProjectManager/TB_Task_SubmitCheckResult.aspx?GuidID=" + dataid;
