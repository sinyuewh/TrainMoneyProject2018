...
CodeBehind="Tb_Project_Log_ADD.aspx.cs" Inherits="OAWebSite2016.SysManager.WebUI.ProjectLogMng.Tb_Project_Log_ADD" %>
   ...
   <jasp:JDataSource ID="data1" runat="server" JType="Table" SqlID="Tb_Project_Log" IsNoConditionNoData="true">
    ...
    <div style="display: none">
        ...
        <jasp:JTextBox class="input-text"  ID="FinishTime" runat="server" DataType="DateTime"
                Caption="实际完成"  onclick="$.calendar();" />
    </div>
    <jasp:JDataBean ID="bean1" runat="server" DataSourceID="data1" ControlList="GuidID,Stitle,Content,PlanTime,FinishTime,Remark,parentGuid"
     ...
     <div class="row cl">
        ...
        <div class="formControls col-8">
            <jasp:JTextBox class="input-text"  ID="PlanTime" runat="server" DataType="DateTime"
                Caption="计划完成" onclick="$.calendar();" AllowNullValue="false" ToolTip="提交后，将不能修改" />
        </div>    
    </div>
