<%@ Page Title="" Language="C#" MasterPageFile="~/SysManager/include/H-uiThird.Master"
    AutoEventWireup="true" CodeBehind="JOrg_Detail.aspx.cs" Inherits="OAWebSite2016.SysManager.WebUI.SysMng.JOrg_Deatil_Read" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!--定义数据豆-->
    <jasp:JDataBean ID="bean1" runat="server" DataSourceID="data1" ControlList="Num,OrgID,OrgName,Parent,Status"
    ...
    <div style="display: none">
        <jasp:JTextBox class="input-text" AllowNullValue="false" ID="OrgID" runat="server"
            Caption="部门编码" IsUnique="true" UniqueTable="JOrg" />
    </div>
    <!--数据Form-->
    <div class="row cl">
