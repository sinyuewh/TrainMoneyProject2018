...
{
    public partial class JOrg_Deatil_Read : System.Web.UI.Page
    {
        ...
        protected override void OnPreRenderComplete(EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (this.Parent1.Items.FindByValue(this.Parent.Text)!=null)
                {
                    this.Parent1.SelectedValue = this.Parent.Text;
                }
            }
