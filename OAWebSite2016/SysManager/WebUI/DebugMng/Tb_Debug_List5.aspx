<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tb_Debug_List5.aspx.cs"
    MasterPageFile="~/SysManager/include/H-uiSecond.Master" 
    Inherits="OAWebSite2016.SysManager.WebUI.WorkPlanMng.Tb_Debug_List5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--导航区设置-->
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> BUG管理 <span class="c-gray en">&gt;</span> 已取消BUG <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="pd-20">
        <!--查询区设置-->
        ...
        <jasp:JDataSource ID="data1" runat="server" JType="Table" SqlID="Tb_Task" PageSize="-1"
            ...
            <ParaItems>
                ...
                <jasp:ParameterItem ParaType="Control" ParaName="Time1" DataName="AddTime<=cdate('{0} 23:59:59')"
                    SearchOperator="UserDefine" />
                <jasp:ParameterItem ParaType="String" ParaName="xx" DataName="Tb_Task.Status ='9'"
                    SearchOperator="UserDefine" />
