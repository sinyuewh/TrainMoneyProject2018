<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tb_Debug_List1.aspx.cs"
    MasterPageFile="~/SysManager/include/H-uiSecond.Master" Inherits="OAWebSite2016.SysManager.WebUI.WorkPlanMng.Debug_List1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!--导航区设置-->
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> BUG管理 <span class="c-gray en">&gt;</span> 完成中BUG <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="pd-20">
        <!--查询区设置-->
        <div class="text-c">
                        ...
                        <ItemTemplate>
                            <tr class="text-c">
                                ...
                                <td class="operate">
                                    <% if (this.IsManager)
                                       { %>
                                    <a onclick="javascript:return TuiTask('<%#Eval("GuidID") %>');" href='#' title="将BUG退回，重新安排">
    ...
    <script type="text/javascript">
        ...
        function SubmitCheckTask(dataid) {
            layer.confirm("提示：确定要【提交BUG审核】吗？", function() {
                $.ajax({
                    type: 'POST',
                    url: "Handler/DoAction.aspx",
                    data: {
                    ...
                    success: function(data) {
                        if ("ok" == data) {
                            layer.alert("【提交BUG审核】操作成功！", function() {
                                $('#butSearch').click();  //重新加载页面
                            });
                        } else {
                            layer.alert("【提交BUG审核】操作失败！");
                        }
                    }
                });
            });
