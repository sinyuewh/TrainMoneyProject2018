<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tb_Task_ImportExcelBUG.aspx.cs"
MasterPageFile="~/SysManager/include/H-uiThird.Master" 
 Inherits="OAWebSite2016.SysManager.WebUI.WorkPlanMng.Tb_Task_ImportExcelBUG" %>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-7">
           <span class="select-box" >
                ...
                Caption ="BUG工单Excel数据" class="input-text" AllowNullValue="false"  />
            </span>
        </div>
    </div>    
    <div class="row cl">
        ...
        <div class="formControls col-7">
            <span class="operate">
            <a href="/Attachment/Data/BUGTask.xls">[点击下载]</a>
            </span>
        </div>
    </div>   
