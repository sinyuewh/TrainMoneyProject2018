<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tb_Task_DetailBUG_Add.aspx.cs"
    MasterPageFile="~/SysManager/include/H-uiThird.Master" 
    Inherits="OAWebSite2016.SysManager.WebUI.WorkPlanMng.Tb_Task_DetailBUG_Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="display:none">
        ...
        <jasp:JTextBox ID="BigKind" runat="server" TextDefaultValue="String1"></jasp:JTextBox>
    ...
    <jasp:JDataBean ID="bean1" runat="server" 
        ControlList="parentGuid,BigKind,TaskKind,TaskTitle,SubTitle,content,BugKind,ImportGrade,TimeGrade,Workload,AddTime,PlanDate,GuidID,Remark"
    ...
    <div class="row cl" style ="display:none" >
        ...
        <div class="formControls col-8">
           <jasp:JTextBox class="input-text" AllowNullValue="false" ID="TaskKind" runat="server" Text="BUG" />
        </div>
    </div> 
    ...
    <div class="row cl">
        <label class="form-label col-2">
            功能项：</label>
        <div class="formControls col-8">
            <jasp:JTextBox class="input-text" ID="SubTitle" runat="server"
                Caption="功能项"  />
        </div>
    </div>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-8">
            <jasp:JTextBox class="input-text" AllowNullValue="false" ID="content" runat="server"
                Caption="工单内容"  TextMode="MultiLine" Height="100px" />
        </div>
    </div>
    ...
    <div class="row cl">
        <label class="form-label col-2">
            类别：</label>
        <div class="formControls col-8">
            <jasp:JTextBox class="input-text" ID="BugKind" runat="server"
                Caption="类别"  />
        </div>
    </div>
    ...
    <div class="row cl" >
        <label class="form-label col-2">
            发现日期：</label>
        <div class="formControls col-8">
            <jasp:JTextBox class="input-text" AllowNullValue="false" ID="AddTime" runat="server"
                Caption="发现日期" onclick="$.calendar();" DataType="DateTime"  />
        </div>
    </div>
    ...
    <div class="row cl" >
        <label class="form-label col-2">
            要求完成：</label>
        <div class="formControls col-8">
            <jasp:JTextBox class="input-text" ID="PlanDate" runat="server"
