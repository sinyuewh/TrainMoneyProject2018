<%@ Page Title="" Language="C#" MasterPageFile="~/SysManager/include/Third.Master"
    AutoEventWireup="true" CodeBehind="Welcome.aspx.cs" 
    Inherits="OAWebSite2016.SysManager.welcome1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="pd-20" style="padding-top: 20px;">
        ...
        <p class="f-20 text-success">
            欢迎使用<%=ConfigurationManager.AppSettings["WebTitle"] %> <span class="f-14"><%=ConfigurationManager.AppSettings["Version"] %></span></p>
        <p>
