...
(
  id       integer,									--数据ID
  linetype varchar(50) not null,					--线路类型
  linename varchar(50) not null,					--线路类型名称
  fee1     numeric(18,2),							--运行时速大于300km/h高速动车组票价列车（单组）
  fee2    numeric(18,2),							--运行时速大于300km/h高速动车组票价列车（重联）
  fee3    numeric(18,2),							--其他高速动车组票价列车（单组）
  fee4    numeric(18,2),							--其他高速动车组票价列车（重联）
  fee5    numeric(18,2),							--空调列车线路使用费
  fee6    numeric(18,2)								--非空调列车线路使用费
)
;
