...
namespace KORWeb.DAL
{
    /// 说明：Tb_WorkReminder
    /// 编码：金寿吉
    /// 时间：2016/10/17 10:04:11
    public partial  class Tb_WorkReminderDA
    {
        #region 通用的数据DAL
        private String tableName = "Tb_WorkReminder";
        ...
        public Tb_WorkReminderDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(Tb_WorkReminderDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,Tb_WorkReminderDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_WorkReminderDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_WorkReminderDD data1=tab1.GetFirstDataEntity<Tb_WorkReminderDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
