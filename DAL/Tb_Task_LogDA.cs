...
namespace KORWeb.DAL
{
    ...
    public partial  class Tb_Task_LogDA
    {
        #region 通用的数据DAL
        private String tableName = "Tb_Task_Log";
        ...
        public Tb_Task_LogDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(Tb_Task_LogDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,Tb_Task_LogDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_Task_LogDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_Task_LogDD data1=tab1.GetFirstDataEntity<Tb_Task_LogDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
