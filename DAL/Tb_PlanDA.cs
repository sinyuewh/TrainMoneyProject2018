...
namespace KORWeb.DAL
{
    ...
    public partial  class Tb_PlanDA
    {
        #region 通用的数据DAL
        private String tableName = "Tb_Plan";
        ...
        public Tb_PlanDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(Tb_PlanDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,Tb_PlanDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_PlanDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_PlanDD data1=tab1.GetFirstDataEntity<Tb_PlanDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
