...
namespace KORWeb.DAL
{
    /// 说明：Tb_PlanDetail
    /// 编码：王松
    /// 时间：2016/8/11 17:28:23
    public partial  class Tb_PlanDetailDA
    {
        #region 通用的数据DAL
        private String tableName = "Tb_PlanDetail";
        ...
        public Tb_PlanDetailDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(Tb_PlanDetailDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,Tb_PlanDetailDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_PlanDetailDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_PlanDetailDD data1=tab1.GetFirstDataEntity<Tb_PlanDetailDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
