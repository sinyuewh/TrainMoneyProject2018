...
namespace KORWeb.DAL
{
    ...
    public partial  class Tb_DebugDA
    {
        #region 通用的数据DAL
        private String tableName = "Tb_Debug";
        ...
        public Tb_DebugDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(Tb_DebugDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,Tb_DebugDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_DebugDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_DebugDD data1=tab1.GetFirstDataEntity<Tb_DebugDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
