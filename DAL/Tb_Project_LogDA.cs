...
namespace KORWeb.DAL
{
    /// 说明：Tb_Project_Log
    /// 编码：超级用户
    /// 时间：2016/8/8 22:57:57
    public partial  class Tb_Project_LogDA
    {
        #region 通用的数据DAL
        private String tableName = "Tb_Project_Log";
        ...
        public Tb_Project_LogDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(Tb_Project_LogDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,Tb_Project_LogDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_Project_LogDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_Project_LogDD data1=tab1.GetFirstDataEntity<Tb_Project_LogDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
