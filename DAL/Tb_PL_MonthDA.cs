...
namespace KORWeb.DAL
{
    /// 说明：Tb_PL_Month
    /// 编码：超级用户
    /// 时间：2016/10/27 16:48:39
    public partial  class Tb_PL_MonthDA
    {
        #region 通用的数据DAL
        private String tableName = "Tb_PL_Month";
        ...
        public Tb_PL_MonthDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(Tb_PL_MonthDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,Tb_PL_MonthDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_PL_MonthDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_PL_MonthDD data1=tab1.GetFirstDataEntity<Tb_PL_MonthDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
