...
namespace KORWeb.DAL
{
    ...
    public partial  class Tb_TaskDA
    {
        #region 通用的数据DAL
        ...
        public Tb_TaskDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(Tb_TaskDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,Tb_TaskDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_TaskDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_TaskDD data1=tab1.GetFirstDataEntity<Tb_TaskDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
