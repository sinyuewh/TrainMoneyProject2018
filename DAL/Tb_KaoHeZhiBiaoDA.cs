...
namespace KORWeb.DAL
{
    ...
    public partial  class Tb_KaoHeZhiBiaoDA
    {
        #region 通用的数据DAL
        private String tableName = "Tb_KaoHeZhiBiao";
        ...
        public Tb_KaoHeZhiBiaoDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void EditData(List<SearchField> condition,Tb_KaoHeZhiBiaoDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_KaoHeZhiBiaoDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_KaoHeZhiBiaoDD data1=tab1.GetFirstDataEntity<Tb_KaoHeZhiBiaoDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
