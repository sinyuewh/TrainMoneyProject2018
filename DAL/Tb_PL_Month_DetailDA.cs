...
namespace KORWeb.DAL
{
    ...
    public partial  class Tb_PL_Month_DetailDA
    {
        #region 通用的数据DAL
        private String tableName = "Tb_PL_Month_Detail";
        ...
        public Tb_PL_Month_DetailDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void EditData(List<SearchField> condition,Tb_PL_Month_DetailDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_PL_Month_DetailDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_PL_Month_DetailDD data1=tab1.GetFirstDataEntity<Tb_PL_Month_DetailDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
