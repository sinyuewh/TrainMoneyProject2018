...
namespace KORWeb.DAL
{
    /// 说明：Tb_KaoHeOther
    /// 编码：
    /// 时间：2016/10/26 19:19:31
    public partial  class Tb_KaoHeOtherDA
    {
        #region 通用的数据DAL
        private String tableName = "Tb_KaoHeOther";
        ...
        public Tb_KaoHeOtherDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(Tb_KaoHeOtherDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,Tb_KaoHeOtherDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_KaoHeOtherDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_KaoHeOtherDD data1=tab1.GetFirstDataEntity<Tb_KaoHeOtherDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
