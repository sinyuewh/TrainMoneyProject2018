...
namespace KORWeb.DAL
{
    /// 说明：Tb_KH_Month
    /// 编码：金寿吉
    /// 时间：2016/8/27 11:04:40
    public partial  class Tb_KH_MonthDA
    {
        #region 通用的数据DAL
        private String tableName = "Tb_KH_Month";
        ...
        public Tb_KH_MonthDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(Tb_KH_MonthDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,Tb_KH_MonthDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_KH_MonthDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_KH_MonthDD data1=tab1.GetFirstDataEntity<Tb_KH_MonthDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
