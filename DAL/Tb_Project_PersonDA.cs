...
namespace KORWeb.DAL
{
    ...
    /// 编码：超级用户
    /// 时间：2016/8/8 14:46:52
    public partial  class Tb_Project_PersonDA
    {
        #region 通用的数据DAL
        private String tableName = "Tb_Project_Person";
        ...
        public Tb_Project_PersonDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(Tb_Project_PersonDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,Tb_Project_PersonDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_Project_PersonDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_Project_PersonDD data1=tab1.GetFirstDataEntity<Tb_Project_PersonDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
