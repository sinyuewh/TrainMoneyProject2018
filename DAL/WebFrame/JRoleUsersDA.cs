...
namespace KORWeb.DAL
{
    ...
    public partial  class JRoleUsersDA
    {
        #region 通用的数据DAL
        private const String TableName = "JRoleUsers";
        ...
        public JRoleUsersDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(JRoleUsersDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,JRoleUsersDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public JRoleUsersDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            JRoleUsersDD data1=tab1.GetFirstDataEntity<JRoleUsersDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
