...
namespace KORWeb.DAL
{
    ...
    public partial  class JUserUrlDA
    {
        #region 通用的数据DAL
        private const String TableName = "JUserUrl";
        ...
        public JUserUrlDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(JUserUrlDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,JUserUrlDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public JUserUrlDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            JUserUrlDD data1=tab1.GetFirstDataEntity<JUserUrlDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
