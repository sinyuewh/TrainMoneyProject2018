...
namespace KORWeb.DAL
{
    ...
    public partial  class JSqlInfoDA
    {
        #region 通用的数据DAL
        private const String TableName = "JSqlInfo";
        ...
        public JSqlInfoDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(JSqlInfoDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,JSqlInfoDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public JSqlInfoDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            JSqlInfoDD data1=tab1.GetFirstDataEntity<JSqlInfoDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
