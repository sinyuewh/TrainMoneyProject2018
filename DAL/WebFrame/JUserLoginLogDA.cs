...
namespace KORWeb.DAL
{
    ...
    public partial  class JUserLoginLogDA
    {
        #region 通用的数据DAL
        private const String TableName = "JUserLoginLog";
        private JConnect daConnect = null;
        
        /// <summary>
        /// 无参数构造函数
        /// </summary>
        public JUserLoginLogDA()
        {
        ...
        public JUserLoginLogDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(JUserLoginLogDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,JUserLoginLogDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public JUserLoginLogDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            JUserLoginLogDD data1=tab1.GetFirstDataEntity<JUserLoginLogDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
