...
namespace KORWeb.DAL
{
    ...
    public partial  class JRoleDA
    {
        ...
        public void NewData(JRoleDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,JRoleDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public JRoleDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            JRoleDD data1=tab1.GetFirstDataEntity<JRoleDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
