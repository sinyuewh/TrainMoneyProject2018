...
namespace KORWeb.DAL
{
    ...
    public partial  class JOrgUsersDA
    {
        #region 通用的数据DAL
        private const String TableName = "JOrgUsers";
        ...
        public JOrgUsersDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(JOrgUsersDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,JOrgUsersDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public JOrgUsersDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            JOrgUsersDD data1=tab1.GetFirstDataEntity<JOrgUsersDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
