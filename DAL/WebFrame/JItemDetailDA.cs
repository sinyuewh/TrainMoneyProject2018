...
namespace KORWeb.DAL
{
    ...
    public partial  class JItemDetailDA
    {
        #region 通用的数据DAL
        private const String TableName = "JItemDetail";
        ...
        public JItemDetailDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(JItemDetailDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,JItemDetailDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public JItemDetailDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            JItemDetailDD data1=tab1.GetFirstDataEntity<JItemDetailDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
