...
namespace KORWeb.DAL
{
    ...
    public partial  class JModelDA
    {
        #region 通用的数据DAL
        private const String TableName = "JModel";
        ...
        public void EditData(List<SearchField> condition,JModelDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public JModelDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            JModelDD data1=tab1.GetFirstDataEntity<JModelDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
