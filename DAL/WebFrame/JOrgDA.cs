...
namespace KORWeb.DAL
{
    ...
    public partial  class JOrgDA
    {
        #region 通用的数据DAL
        private const String TableName = "JOrg";
        ...
        public void NewData(JOrgDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,JOrgDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public JOrgDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            JOrgDD data1=tab1.GetFirstDataEntity<JOrgDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
