...
namespace KORWeb.DAL
{
    ...
    public partial  class JUserActionLogDA
    {
        #region 通用的数据DAL
        private const String TableName = "JUserActionLog";
        ...
        public JUserActionLogDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public JUserActionLogDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            JUserActionLogDD data1=tab1.GetFirstDataEntity<JUserActionLogDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
