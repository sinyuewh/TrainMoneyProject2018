...
namespace KORWeb.DAL
{
    ...
    public partial  class JUserDataDA
    {
        #region 通用的数据DAL
        private const String TableName = "JUserData";
        ...
        public JUserDataDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(JUserDataDD data1)
        {
        ...
        public JUserDataDD GetFirstDataEntity(List<SearchField> condition, params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            JUserDataDD data1 = tab1.GetFirstDataEntity<JUserDataDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
