...
namespace KORWeb.DAL
{
    /// 说明：数据操作类
    /// 编码：jsj
    /// 时间：2013-8-2 14:54:48
    public partial  class JAuthorityDA
    {
        #region 通用的数据DAL
        private const String TableName = "JAuthority";
        ...
        public JAuthorityDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(JAuthorityDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,JAuthorityDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public JAuthorityDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            JAuthorityDD data1=tab1.GetFirstDataEntity<JAuthorityDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
