...
namespace KORWeb.DAL
{
    ...
    public partial  class JAuthorityRolesDA
    {
        #region 通用的数据DAL
        private const String TableName = "JAuthorityRoles";
        private JConnect daConnect = null;
        
        /// <summary>
        /// 无参数构造函数
        /// </summary>
        public JAuthorityRolesDA()
        {
        ...
        public JAuthorityRolesDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(JAuthorityRolesDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,JAuthorityRolesDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public JAuthorityRolesDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            JAuthorityRolesDD data1=tab1.GetFirstDataEntity<JAuthorityRolesDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
