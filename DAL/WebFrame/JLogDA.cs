...
{
   public partial class JLogDA
    {
        #region 通用的数据DAL
        private String tableName = "JLog";
        ...
        public void NewData(JLogDD data1)
        {
        ...
        public void EditData(List<SearchField> condition, JLogDD data1)
        {
            JTable tab1 = new JTable(daConnect, TableName);
        ...
        public JLogDD GetFirstDataEntity(List<SearchField> condition, params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect, TableName);
            JLogDD data1 = tab1.GetFirstDataEntity<JLogDD>(condition, Fields);
            tab1.Close();
            return data1;
        }
