...
namespace KORWeb.DAL
{
    ...
    public partial  class JStrInfoDA
    {
        #region 通用的数据DAL
        ...
        public JStrInfoDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(JStrInfoDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,JStrInfoDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public JStrInfoDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            JStrInfoDD data1=tab1.GetFirstDataEntity<JStrInfoDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
