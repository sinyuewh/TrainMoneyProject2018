...
namespace KORWeb.DAL
{
    ...
    public partial  class Tb_WorkLogDA
    {
        #region 通用的数据DAL
        private String tableName = "Tb_WorkLog";
        ...
        public Tb_WorkLogDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void NewData(Tb_WorkLogDD data1)
        {
        ...
        public void EditData(List<SearchField> condition,Tb_WorkLogDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_WorkLogDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_WorkLogDD data1=tab1.GetFirstDataEntity<Tb_WorkLogDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
