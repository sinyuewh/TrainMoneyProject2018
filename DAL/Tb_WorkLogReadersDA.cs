...
namespace KORWeb.DAL
{
    ...
    /// 编码：苏纽兵
    /// 时间：2016/8/19 16:11:52
    public partial  class Tb_WorkLogReadersDA
    {
        #region 通用的数据DAL
        private String tableName = "Tb_WorkLogReaders";
        ...
        public Tb_WorkLogReadersDA(JConnect conn)
        {
            this.daConnect = conn;
        }
        ...
        public void EditData(List<SearchField> condition,Tb_WorkLogReadersDD data1)
        {
            JTable tab1 = new JTable(daConnect,TableName);
        ...
        public Tb_WorkLogReadersDD GetFirstDataEntity(List<SearchField> condition,params String[] Fields)
        {
            JTable tab1 = new JTable(daConnect,TableName);
            Tb_WorkLogReadersDD data1=tab1.GetFirstDataEntity<Tb_WorkLogReadersDD>(condition, Fields);
            tab1.Close();
            return data1;
        }    
